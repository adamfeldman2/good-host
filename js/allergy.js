...
allergyApp.getRecipes = function(query, allAllergies) {
	...
	.then(function(recipeData) {
		...
		if(filteredRecipes.length === 0) {
			$('.resultsUl').html('<h3 class="noResults">No Recipes Found <i class="fa fa-frown-o" aria-hidden="true"></i></h3><label for="recipeSearch" class="searchAgain">Search again</label>');
		}
	});
